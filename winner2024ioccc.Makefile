...
#
CSILENCE= -Wno-strict-prototypes -Wno-parentheses -Wno-strict-aliasing
...
#
COTHER= -ffast-math -DQ='fputs("\033[H",stdout);'
...
#           make all CC=clang
#
CSILENCE+= -Wno-comma -Wno-declaration-after-statement -Wno-double-promotion \
	...
	-Wno-shadow -Wno-strict-prototypes -Wno-unsafe-buffer-usage
#
CWARN+= -Weverything
#
endif
