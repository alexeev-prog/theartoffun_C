...
Разберем теперь более простую функцию быстрого модуля 2^n:ы
...
![](https://habrastorage.org/webt/xk/03/pm/xk03pmal184trrrzth67jskuoto.png)

И вот график по математическим и прочим алгоритмам:

![](https://habrastorage.org/webt/cq/ni/rn/cqnirnerl-igfmzexgtfhkmtcku.png)
